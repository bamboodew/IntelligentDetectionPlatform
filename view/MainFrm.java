...
//		mntmjava.addActionListener(new ActionListener() {
		...
		// java1234InterFrm.getWidth())/2;
		// int h = (Toolkit.getDefaultToolkit().getScreenSize().height -
		// java1234InterFrm.getHeight())/2;
	...
	public void setJIFLocationToCenter(JInternalFrame JIF) {
		int w = (Toolkit.getDefaultToolkit().getScreenSize().width - JIF.getWidth()) / 2;
		int h = (Toolkit.getDefaultToolkit().getScreenSize().height - JIF.getHeight()) / 3; // 竖向黄金分割
		JIF.setLocation(w, h);
